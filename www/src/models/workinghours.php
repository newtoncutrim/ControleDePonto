...
class WorkingHours extends Model {
    ...
    {
        [$t1,,, $t4] = $this->getTimes();
        $workday = new DateInterval('PT0S');
        $workday = DateInterval::createFromDateString('8hours');
    ...
    public static function getAbsentUsers(){
        $today = new DateTime();
        $result = Database::getResultFromQuerry("
